...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_NUM_PICOBLAZE" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_NUM_PICOBLAZE { PARAM_VALUE.C_NUM_PICOBLAZE } {
	# Procedure called to update C_NUM_PICOBLAZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_NUM_PICOBLAZE { PARAM_VALUE.C_NUM_PICOBLAZE } {
	# Procedure called to validate C_NUM_PICOBLAZE
	return true
}


proc update_MODELPARAM_VALUE.C_NUM_PICOBLAZE { MODELPARAM_VALUE.C_NUM_PICOBLAZE PARAM_VALUE.C_NUM_PICOBLAZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NUM_PICOBLAZE}] ${MODELPARAM_VALUE.C_NUM_PICOBLAZE}
}
